      ...
      <nav className="w-20 lg:w-64 border-r border-white/5 bg-white/5 backdrop-blur-md flex flex-col justify-between hidden md:flex shrink-0">
        <div>
          ...
          <div className="px-4 py-8 space-y-2">
             ...
             <Link href="/dashboard/study" className="flex items-center gap-3 px-4 py-3 rounded-xl text-white/70 hover:text-white hover:bg-white/10 transition-colors group">
