...
export default function UnifiedDashboard() {
  ...
  const handleDownloadResume = () => {
    ...
    if (Array.isArray(resumeResult.skills)) {
      skillsString = resumeResult.skills.join(', ');
    } else if (typeof resumeResult.skills === 'string') {
      ...
      <main className="relative z-10 flex-1 flex flex-col max-w-[1400px] w-full mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="w-[120px] flex justify-end">
            <button onClick={handleStartSession} className="bg-white/10 text-white px-4 py-2 rounded-full text-xs font-medium hover:bg-white/20 transition-colors flex items-center gap-2 border border-white/5">
              ...
              {!resumeResult ? (
                <form onSubmit={handleGenerateResume} className="space-y-5 flex-1 flex flex-col">
                  ...
                  <div className="space-y-3 mt-4">
                    ...
                    <button type="button" onClick={() => fileInputRef.current?.click()} disabled={flowState !== 'resume' || isUploadingResume} className="w-full bg-white/5 border border-white/10 text-white py-3 rounded-xl font-medium hover:bg-white/10 transition-colors disabled:opacity-50 flex justify-center items-center gap-2">
                       {isUploadingResume ? (
                ...
                <div className="flex flex-col h-full animate-fade-rise">
                  ...
                  <div className="mt-6 flex justify-between items-center">
                    ...
                    <button onClick={handleDownloadResume} className="flex items-center gap-2 text-sm bg-white/10 hover:bg-white/20 px-4 py-2 rounded-lg text-white transition-colors">
